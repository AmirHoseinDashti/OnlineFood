...
{
    public partial class initTblDatabas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(97)", maxLength: 97, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "سس گوجه فرنگی تازه، قارچ، پنیرپیتزا", 1, "پیتزا قارچ" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Description", "ItemId", "Name" },
                values: new object[] { 2, "سس گوجه فرنگی تازه، ژامبون مرغ، پنیر پیتزا", 2, "پیتزا ژامبون" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Description", "ItemId", "Name" },
                values: new object[] { 3, "۳۰۰ گرم مغز راسته گوسفندی، ۳۶۰ گرم برنج ایرانی، ته چین", 3, "چلو کباب چنجه" });
